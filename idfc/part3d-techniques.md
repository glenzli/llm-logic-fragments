...
> **本文内容**：§17–§25，包含 Tool Use、Test-time Compute / o1、RAG、Speculative Decoding、多模态、持续学习、ICL、合成数据坍缩（Model Collapse）、F-空间内容三态分类。
