...
> **定位**：本文是 IDFC 理论的**建模层**。[Part 1](part1-intro.md) 给出了非正式动机与预测概览；本文在此基础上建立形式化数学模型，并完整证明核心定理 CAC。
>
> **后续**：[Part 3](part3-deductions.md) 从 CAC 定理推导全部推论；[Part 4](part4-empirical.md) 以多架构分析与多组实验场景验证本文的理论预测。
